...
$path = '../../growth-dev/modules/custom/growth_migrate/fixtures/section_page/';
...
$fields_config = [
  ...
  [
    ...
    'remove' => ['h1', '.abstract', 'div.newsroom-item:not(.custom-content):not(.twitterfeed):not(.skipto)', '#ec-widget-share-button']
  ]
];
...
foreach ($docs as $doc_id) {
  echo ++$counter.' of '.$total_docs.' '.$doc_id.PHP_EOL;
